...
module.exports = class Html5RepoTemplate extends require('../../plugin') {
    ...
    async combine() {
        const project = readProject()
        const { isJava, srvPath, appPath, hasMta, hasXsuaa, hasMultitenancy, hasWorkzoneStandard, hasHelm, hasHelmUnifiedRuntime, hasApprouter, hasContainerize, apps } = project
        ...
        if (hasMultitenancy) {
            await merge({ cds: { requires: { 'html5-runtime':true } } }).into('mtx/sidecar/package.json')
        }
