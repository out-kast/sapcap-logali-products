 ...
 *  src?: string,
 *  dest?: string,
 * } & {[key:string]:unknown}} BuildTaskProviderFactoryOptions
 */
...
class BuildTaskProviderFactory {
    /**
     * @param {BuildTaskProviderFactoryOptions} options - build options
     */
    constructor(options = {}) {
        ...
        /** @type {{ options: BuildTaskProviderFactoryOptions, tasks: Task}} */
